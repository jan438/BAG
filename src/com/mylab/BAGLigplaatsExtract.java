...
public class BAGLigplaatsExtract {

	public void process_ligplaatsen() {
		...
		try {
			out = new PrintWriter(new BufferedWriter(new FileWriter(
					BAGHttpURLConnection.js_ligplaats_file, true)));
		...
		try {
			...
			saxParser.parse(BAGHttpURLConnection.kml_ligplaats_file, handler);
